        ...
        <div className="relative z-10 w-full max-w-md text-center lg:text-left">
          ...
          <div className="space-y-6 mb-8 lg:mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
              Create your agent account with secure phone verification.
            </p>
          </div>

          <div className="mt-8 lg:mt-12 pt-8 border-t border-cyan-400/20 dark:border-cyan-500/20">
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Secure agent registration powered by Claimly platform.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="card shadow-card-3d-hover p-8 sm:p-10 border border-gray-200 dark:border-navy-700">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-navy-700">
              ...
              <button
                ...
                className="w-full text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 flex items-center justify-center space-x-2"
              >
